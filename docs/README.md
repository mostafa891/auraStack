...
### 1. [Developer Onboarding & Contributing](file:///a:/auraflow/docs/contributing/index.md)
*   **Quickstart Guide:** Run the engine locally in 3 steps.
*   **Code Standards:** Ruff configuration, formatting, and pre-commit hooks.

### 2. [Architecture](file:///a:/auraflow/docs/architecture/database.md)
*   **[Database Architecture](file:///a:/auraflow/docs/architecture/database.md):** UUID primary keys, Soft Delete logic, database indexes, and transactions.
*   **[Configuration](file:///a:/auraflow/docs/architecture/configuration.md):** Settings split (dev, test, production) and environment variable management.
*   **[Error Handling](file:///a:/auraflow/docs/architecture/errors.md):** Uniform API validation response structures, standard exceptions, and logging.
*   **[Django Ninja API](file:///a:/auraflow/docs/architecture/api-ninja.md):** Type-safe endpoints, public/private routing, and Pydantic validation.

### 3. [Authentication & Security](file:///a:/auraflow/docs/authentication/index.md)
...
### 4. [Multi-Tenancy & Isolation](file:///a:/auraflow/docs/multi-tenancy/index.md)
...
### 5. [Billing & Subscriptions](file:///a:/auraflow/docs/billing/index.md)
...
### 6. [Background Jobs](file:///a:/auraflow/docs/background-jobs/index.md)
*   **Django Q2:** Background task queues using the database ORM as the broker.

### 7. [Testing](file:///a:/auraflow/docs/testing/index.md)
...
### 8. [Deployment](file:///a:/auraflow/docs/deployment/index.md)
